...
\                   /
 \                 /
  \               /
   \_____________/
```
{{< hexmap layout="cols" colCounts="3,2,2,1" size=18 gap=8 cssWidth="min(1100px,92vw)" labelSize=11 nested=true innerScale=0.82 strokeWidth=0.9 labels="-,-,-,-,-,-,-,-"  /* all blanks; just the grid */ urls=",,,,,,,">}}
<br>
